(function () {
	...
	function getWorkTime(initData,startTime, endTime){
		...
		if (oneWorkDayTimeLong <=0 ){
			...
			console.log("一个工作日时间为 = " + oneWorkDayTimeLong);
		}
		...
		console.log(workDayTimeLongList);
		console.log(initData);

		console.log("总工作时间：" + (workTimeLong/1000) + "")
	...
	getWorkTime(initData,new Date(startTime_1), new Date(endTime_1));
